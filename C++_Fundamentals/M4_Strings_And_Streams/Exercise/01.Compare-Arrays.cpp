...
std::array<int, maxSize> getInputArray(int& arrSize) {
    arrSize = 0;
...
int main() {
    int arrayOneSize = 0;
    std::array<int, maxSize> arrayOne = getInputArray(arrayOneSize);

    int arrayTwoSize = 0;
    std::array<int, maxSize> arrayTwo = getInputArray(arrayTwoSize);
