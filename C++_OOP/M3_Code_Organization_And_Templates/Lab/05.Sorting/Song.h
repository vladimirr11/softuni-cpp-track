...
// NOTE: this is intentional - it defines an ordering by name, so that you can't use an 
// operator overload to order the Song objects in the task. Think of a different approach
