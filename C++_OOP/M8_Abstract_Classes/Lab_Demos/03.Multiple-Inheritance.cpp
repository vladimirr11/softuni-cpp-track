...
public:
    ...
    Animal(double movementSpeed) : movementSpeed(movementSpeed) {}
...
public:
    ...
    Plant(bool hasSeeds) : hasSeeds(hasSeeds) {}
...
public:
    GMO(double movementSpeed, bool hasSeeds) : Animal(movementSpeed),
                                               Plant(hasSeeds) {}
