...
namespace SoftUni {
    // NOTE: depending on the situation, these two "courses" might better be represented as a "class Course"
...
int main() {
    ...
    // vector v; // compilation error - vector is ambiguous, because compiler sees it in both std and Geometry2D, 
