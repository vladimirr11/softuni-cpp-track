...
int main() {
	...
	while (true) {
		// NOTE: if there was no destructor, this would cause a memory leak which would quickly eat up all memory, 
		// due to the new-allocation of 100 integers in the constructor
		IntArray arr(10);
