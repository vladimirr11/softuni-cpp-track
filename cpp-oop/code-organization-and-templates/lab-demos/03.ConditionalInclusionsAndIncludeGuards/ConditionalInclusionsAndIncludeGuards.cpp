...
// because HeaderGuardedFile defines a function, and OtherFileAlsoIncludingHeaderGuardedFile 
// included HeaderGuardedFile, so the function would appear twice
...
void clearScreen() {
    ...
    // in a multi-platform way, but simply to demonstrate the usage of ifdef
#ifdef _WIN32
	system("cls");
#else
	system("clear");
