...
int main() {
    ...
    delete people; // memory leak - we delete the vector, but each Person* inside 
    // it needs to be deleted before that, i.e. for (auto p : people) { delete p; } and only then delete people;
